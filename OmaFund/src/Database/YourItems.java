	      ...
	      try {
	         ...
	         while (rs.next()) {
	            ...
	            if (userID == theUserID)
	            {
	            	...
	            	out.println("<section>" + soldString + "Project: " + name + "<br>" + description + "<br> Price: " + price + "<br><br>");
	            	out.println("<form action=\"ItemSold\" method=\"POST\">\r\n" + 
	            			"				<input type=\"submit\" name=\"" + itemId + "\" value=\"Sold\"/>\r\n" + 
	            			"			</form></section><br>");
	            }
	         }
